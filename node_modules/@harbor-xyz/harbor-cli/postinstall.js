...
async function install(callback) {
    ...
    const src= `./dist/harbor-cli_${opts.version}_${process.platform}_${ARCH_MAPPING[process.arch]}/${opts.binName}`;
    await execShellCommand(`cp ${src} ../../.bin`);
    await execShellCommand(`rm -r ./dist`);
